-- IME (Alacritty/WezTerm起動時のみ有効化)
local terminalFilter = hs.window.filter.new(false)
terminalFilter:setAppFilter("Alacritty")
terminalFilter:setAppFilter("WezTerm")

if terminalFilter then
