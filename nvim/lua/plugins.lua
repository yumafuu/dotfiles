return {
   ...
   --       timeoutlen = 300,
   --       color = "#FF8800",
   --       after_enter = function() require("lualine").refresh() end,
   ...
   --       {
   --         "f",
   --         fn = function() vim.cmd("normal! f") end,
   --       },
   --       {
   --         key = "F",
   --         desc = "Next Char Backward",
   --         fn = function() vim.cmd("normal! F") end,
   --       },
   --       {
   --         key = "t",
   --         desc = "Till Char Forward",
   --         fn = function() vim.cmd("normal! t") end,
   --       },
   --       {
   --         key = "T",
   ...
   --         key = "<Esc>",
   --         desc = "Exit Smart-F",
   --         fn = function() sm.disable() end,
   --       },
   --     })
   --     vim.keymap.set("n", "f", function() sm.enable(sm_smart_f, "f") end)
   --     vim.keymap.set("n", "F", function() sm.enable(sm_smart_f, "F") end)
   --   end,
   -- },
   {
      ...
      config = function()
         ...
         local function is_deno_project(fname)
            ...
            if file then
               ...
               if
                  first_line
                  and (first_line:match("#!/usr/bin/env.*deno") or first_line:match("#!/usr/bin/env %-S deno"))
               then
                  return true
               end
            end
